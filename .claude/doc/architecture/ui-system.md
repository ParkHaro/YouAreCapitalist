...
tags: [unity, ui, data-visualization, charts, performance]
related: [ecs-design.md, technical-architecture.md, integration-guide.md]
parent: INDEX.md
created: 2025-08-30
updated: 2025-08-30
priority: high
...
[🇰🇷 Korean Version](./ui-system_KOR.md)
...
#### Data-Driven UI
- **Real-time Data Reflection**: Immediately reflect economic data generated from ECS in UI
- **Performance Optimization**: Efficiently display large amounts of numbers and charts
- **User Experience Focus**: Intuitive visualization of complex economic data

#### Reactive UI
```csharp
// UI that automatically reacts to data changes
public class ReactiveEconomyPanel : MonoBehaviour
{
    ...
    {
        // UI elements automatically reflect new data
...
### 1.2 UI Technology Stack

#### Core UI Framework
```yaml
Primary UI:
  - UI Toolkit (Modern UI, performance optimized)
  - USS stylesheets (CSS-like styling)
  - UXML markup (HTML-like structure)
