...
- **한국어 파일** (`*_KOR.md`): 개발자 전용 문서 (AI 소비 불가)

#### ⚠️ 중요: Claude Code 참조 규칙

**모든 비문서화 작업에서 Claude Code는:**
- 항상 `.md` 파일 참조, `_KOR.md` 파일 절대 참조 금지
- 분석, 연구, 구현에 영어 문서 사용
- 문서 번역 작업을 명시적으로 수행하는 경우에만 `_KOR.md` 파일 접근

**이유:**
- `_KOR.md` 파일은 개발자 전용으로 설계됨
- AI 처리 및 자동화에서 일관성 보장
- 자동화된 워크플로에서 언어 혼용 방지
- 인간과 AI 문서 소비의 명확한 분리
